...
//    Box2.object_count=155;
    ...
    cout<<"Total Objects: "<<Box::getCoin()<<endl;  //static function
    cout<<"Total Objects: "<<Box2.getCoin()<<endl;  //static function
    cout<<"Total Objects: "<<Box1.getCoin()<<endl;  //static function
